    ...
    function delegate(element, selector, listener) {
        ...
        return function (e) {
            ...
            var current = selector[0] === '>'
                ? findAll(selector, element).reverse().filter(function (element) {
    ...
    */
    ...
    function stateAPI(UIkit) {
        ...
        UIkit.prototype._initObserver = function () {
            ...
            this._observer.observe(el, {
                attributes: true,
                attributeFilter: attrs.map(function (key) {
                    return hyphenate(key);
                }).concat([this.$name, ("data-" + (this.$name))])
            });
        };
            ...
            toggleElement: function (targets, show, animate$$1) {
                ...
                return new Promise$1(function (resolve) {
                    ...
                    var all = function (targets) {
                        return Promise$1.all(targets.map(function (el) {
    ...
    var Img = {
        ...
        connected: function () {
            ...
            once(this.$el, 'load', function () {
                return this$1.$update(this$1.$el, 'resize');
            });
    ...
    var Animate = {
        ...
        methods: {
            ...
            animate: function (action) {
                ...
                return Promise$1.all(children.map(function (el, i) {

 ...
 */
function pqnhat89_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'pqnhat89_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.pqnhat89-front-page) .entry-title,
...
.colors-custom .pqnhat89-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.pqnhat89-front-page .panel-content .recent-posts article,
...
.colors-custom.pqnhat89-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'pqnhat89_custom_colors_css', $css, $hue, $saturation );
}
